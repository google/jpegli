...
#ifndef JPEGLI_LIB_EXTRAS_TEST_IMAGE_H_
#define JPEGLI_LIB_EXTRAS_TEST_IMAGE_H_
...
class TestImage {
 public:
  ...
  TestImage& SetDataType(JpegliDataType data_type);

  TestImage& SetEndianness(JpegliEndianness endianness);
 ...
 private:
  ...
  JpegliPixelFormat format_ = {3, JPEGLI_TYPE_UINT8, JPEGLI_LITTLE_ENDIAN, 0};

  static void CropLayerInfo(size_t xsize, size_t ysize, JpegliLayerInfo* info);

  static void CropImage(size_t xsize, size_t ysize, extras::PackedImage* image);

  static JpegliDataType DefaultDataType(const JpegliBasicInfo& info);
};

}  // namespace test
}  // namespace jpegli

#endif  // JPEGLI_LIB_EXTRAS_TEST_IMAGE_H_
